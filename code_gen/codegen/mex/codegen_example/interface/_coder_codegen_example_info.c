 ...
 *
 * Code generation for function '_coder_codegen_example_info'
 *
 */
...
#include "_coder_codegen_example_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("codegen_example"));
...
/* End of code generation (_coder_codegen_example_info.c) */
